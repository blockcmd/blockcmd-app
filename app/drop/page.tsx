  ...
  return (
    <div className="flex flex-col gap-16 text-left w-[768px]">
      ...
      <div className="flex flex-col gap-2">
        <h1 className="scroll-m-20 text-4xl font-extrabold tracking-tight lg:text-5xl">Drop</h1>
        <p className="leading-7 [&:not(:first-child)]:mt-6">A simple tool to airdrop on EVM chains</p>
      </div>
